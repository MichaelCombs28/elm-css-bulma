module Bulma.Styled.Form exposing
    ( IsDisabled
    , Field
    , field
    , Control, ControlModifiers, controlModifiers
    , control
    , ControlInputModifiers, controlInputModifiers
    , controlInput
    , controlText, controlPassword, controlEmail, controlPhone
    , ControlTextAreaModifiers, controlTextAreaModifiers
    , controlTextArea
    , ControlSelectModifiers, controlSelectModifiers
    , Option
    , controlSelect, controlSelectRounded
    , controlMultiselect
    , controlLabel
    , label
    , controlCheckBox
    , IsChecked
    , RadioButton
    , controlRadio, controlRadioButton
    , controlButton
    , controlHelp
    , help
...
import Bulma.Styled.Elements exposing (ButtonModifiers, IconBody, button, icon)
...
import Html.Styled.Attributes as Attr exposing (class, disabled, readonly)
...
controlInput ({ size, state, color, expanded, rounded, readonly, disabled, iconLeft, iconRight } as mods) attrs attrs_ =
    let
        controlMods : ControlModifiers msg
        controlMods =
            { expanded = expanded
            , iconLeft = iconLeft
            , iconRight = iconRight
